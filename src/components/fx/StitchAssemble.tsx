    ...
    <section ref={ref} className="relative h-[210vh] bg-ivory md:h-[230vh]">
      <div className="sticky top-0 flex h-screen flex-col items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ scale: reduce ? 1 : discScale, rotate: reduce ? 0 : discRot }} className="relative h-[clamp(220px,42vw,360px)] w-[clamp(220px,42vw,360px)]">
          ...
          >
            <div className="h-full w-full" style={{ background: "linear-gradient(135deg, #F3E7CC, #D8C39A)" }} />
          </motion.div>
          {/* bottom half (rust) */}
          <motion.div
          ...
          >
            <div className="h-full w-full" style={{ background: "linear-gradient(135deg, #D6AE69, #B58A3C)" }} />
          </motion.div>
